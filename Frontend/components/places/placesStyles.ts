...
export const getStyles = (COLORS: any, isDark: boolean) =>
  StyleSheet.create({
    ...
    placesListTrigger: {
      ...
      borderWidth: 1,
      borderColor: isDark ? "rgba(255,255,255,0.08)" : "#D8DCE3",
      backgroundColor: isDark ? "rgba(20,20,22,0.94)" : "rgba(255,255,255,0.98)",
      shadowColor: "#000",
      shadowOffset: { width: 0, height: 4 },
    ...
    placesListTriggerActive: {
      borderColor: isDark ? "rgba(255,255,255,0.14)" : "#C9CFD8",
    },
    placesListTriggerText: {
      color: COLORS.textPrimary,
      fontSize: 13,
      fontWeight: "800",
    },
    ...
    placesListPopupHeader: {
      paddingHorizontal: 18,
      paddingTop: 10,
      paddingBottom: 10,
    },
    placesListPopupHandle: {
      alignSelf: "center",
      width: 42,
      height: 5,
      borderRadius: 999,
      backgroundColor: isDark ? "rgba(255,255,255,0.18)" : "#D6DDE6",
      marginBottom: 14,
    },
    placesListPopupTitle: {
      color: COLORS.textPrimary,
      fontSize: 28,
      fontWeight: "500",
      letterSpacing: -0.9,
    },
    placesListPopupSubtitle: {
      marginTop: 6,
      color: COLORS.textSecondary,
      fontSize: 13,
      fontWeight: "600",
    },
    placesListPopupScroll: {
      flexGrow: 0,
    },
    placesListPopupContent: {
      paddingBottom: 10,
    },
    placesListPopupRow: {
      flexDirection: "row",
      ...
      borderTopColor: isDark ? "rgba(255,255,255,0.08)" : "#E8ECF1",
    },
    placesListPopupRowIcon: {
      width: 50,
      height: 50,
      borderRadius: 16,
      alignItems: "center",
    ...
    placesListPopupRowBody: {
      flex: 1,
      minWidth: 0,
    },
    placesListPopupRowTitle: {
      color: COLORS.textPrimary,
      fontSize: 15,
      lineHeight: 20,
      fontWeight: "700",
    },
    placesListPopupRowEyebrow: {
      marginTop: 3,
      color: COLORS.textSecondary,
      fontSize: 12,
      lineHeight: 17,
    ...
    placesListPopupEmptyState: {
      paddingHorizontal: 18,
      paddingVertical: 24,
      alignItems: "center",
      justifyContent: "center",
    },
    placesListPopupEmptyTitle: {
      color: COLORS.textPrimary,
      fontSize: 15,
      fontWeight: "700",
    },
    placesListPopupEmptySubtitle: {
      marginTop: 6,
      color: COLORS.textSecondary,
      fontSize: 13,
      lineHeight: 18,
    ...
    busRoutePopupRowActive: {
      backgroundColor: isDark ? "rgba(128,0,0,0.1)" : "rgba(80,0,0,0.05)",
    },
    busRoutePopupIcon: {
      width: 50,
      height: 50,
      ...
      alignItems: "center",
      justifyContent: "center",
      backgroundColor: isDark ? "#161619" : "#F3F5F8",
      borderWidth: 1,
      borderColor: isDark ? "rgba(255,255,255,0.06)" : "rgba(12,12,14,0.06)",
      position: "relative",
    },
    busRoutePopupIconActive: {
      backgroundColor: COLORS.primary,
      borderColor: COLORS.primary,
    },
    busRoutePopupLegendSwatch: {
      position: "absolute",
      top: 7,
      left: 7,
      width: 9,
    ...
    busRoutePopupNumberIdle: {
      color: COLORS.textPrimary,
    },
    busRoutePopupEyebrowActive: {
      color: COLORS.textPrimary,
    },
    busRoutePopupActiveIndicator: {
      width: 8,
      height: 8,
      borderRadius: 999,
      backgroundColor: COLORS.primary,
    ...
    busRouteItemActive: {
      backgroundColor: isDark ? "rgba(128,0,0,0.14)" : "rgba(80,0,0,0.07)",
    },
    routeLegendSwatch: {
      width: 10,
      height: 10,
