...
export const getStyles = (COLORS: any, isDark: boolean) =>
  StyleSheet.create({
    ...
    descriptionText: {
      ...
      lineHeight: 18,
      marginBottom: 12,
      paddingHorizontal: 16, // Added padding for better line breaking
    },
    featureWrap: {
      marginTop: 6,
      marginBottom: 8,
    ...
    featurePill: {
      ...
      paddingVertical: 4,
      borderRadius: 999,
      backgroundColor: isDark ? "rgba(255,255,255,0.025)" : "rgba(12,12,14,0.035)",
      borderWidth: 1,
    ...
    featureCountPill: {
      ...
      paddingVertical: 4,
      borderRadius: 999,
      backgroundColor: isDark ? "rgba(255,255,255,0.02)" : "rgba(12,12,14,0.025)",
      borderWidth: 1,
      borderColor: isDark ? "rgba(255,255,255,0.05)" : "rgba(12,12,14,0.06)",
    },
    featureCountText: {
    ...
    occupancyBlock:  { marginBottom: 6, backgroundColor: isDark ? '#161616' : '#F8F9FB', padding: 14, borderRadius: 18, borderWidth: 1, borderColor: isDark ? '#222' : 'rgba(12,12,14,0.08)' },
    occupancyHeaderRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    occupancyLiveLabel: { fontSize: 12, color: '#AAA', fontWeight: '700', marginBottom: 2, textTransform: 'uppercase', letterSpacing: 0.6 },
    occupancyLiveText: { fontSize: 17, fontWeight: '800' },
    occupancyTrack:  {
    ...
    hoursInfoBlock: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 8 },
    inlineLinkRow: {
      flexDirection: "row",
      alignItems: "center",
      gap: 8,
