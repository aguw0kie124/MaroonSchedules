...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: C.white, width: '100%', borderRadius: 16, padding: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 10, elevation: 5 },
  ...
  modalCreateBtn: { backgroundColor: C.maroon, paddingVertical: 10, paddingHorizontal: 18, borderRadius: 12 },
