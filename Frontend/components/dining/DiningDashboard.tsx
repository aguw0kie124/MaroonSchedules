...
const s = StyleSheet.create({
  ...
  subText: { color: '#444', fontSize: 13, marginTop: 4, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
  settingsBtn: { backgroundColor: '#0a0a0a', width: 48, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#1a1a1a' },
  svgContainer: { alignItems: 'center', marginTop: -10 },
  centerInfo: { position: 'absolute', top: CY - 35, alignItems: 'center', width: SW },
  centerVal: { fontSize: 48, fontWeight: '900', color: '#fff', letterSpacing: -1 },
  centerLabel: { color: '#444', fontSize: 11, textTransform: 'uppercase', letterSpacing: 2, fontWeight: '800' },
  streakBadge: { backgroundColor: '#E8922A15', borderColor: '#E8922A', borderWidth: 1.5, borderRadius: 24, paddingHorizontal: 14, paddingVertical: 6, marginTop: 18 },
  streakText: { color: '#E8922A', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  statsGrid: { flexDirection: 'row', gap: 12, paddingHorizontal: 20, marginTop: 25 },
  btnGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, padding: 20, marginTop: 15 },
  navBtn: { 
    width: (SW - 64) / 3, 
  ...
  navIcon: { fontSize: 26 },
  navLabel: { color: '#fff', fontSize: 12, fontWeight: '800', textTransform: 'capitalize' },
});
