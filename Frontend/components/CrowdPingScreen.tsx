    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerTop}>
          ...
          >
            <Text style={styles.newPingText}>
              {showForm ? "✕ Cancel" : "+ New Ping"}
            </Text>
          </Pressable>
        </View>
      </View>
        ...
        {showForm && (
          <Card style={styles.formCard}>
            ...
            >
              {CAMPUS_SPOTS.map((spot) => (
                <Pressable
                  ...
                  style={[
                    styles.spotChip,
                    place === spot && styles.spotChipActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.spotChipText,
                      place === spot && styles.spotChipTextActive,
                    ]}
                  >
                    {spot}
                  </Text>
            ...
            <Text style={styles.formLabel}>
              How crowded? ({getCrowdLabel(crowded)})
            </Text>
            <View style={styles.sliderRow}>
              {[1, 3, 5, 7, 9].map((val) => (
                <Pressable
                  ...
                  style={[
                    styles.sliderBtn,
                    crowded === val && { backgroundColor: getCrowdColor(val) },
                  ]}
            ...
            {/* Loud slider */}
            <Text style={styles.formLabel}>
              How loud? ({loud <= 3 ? "Quiet" : loud <= 6 ? "Moderate" : "Loud"}
              )
            </Text>
            <View style={styles.sliderRow}>
              {[1, 3, 5, 7, 9].map((val) => (
                <Pressable
                  ...
                  style={[
                    styles.sliderBtn,
                    loud === val && { backgroundColor: COLORS.primary },
                  ]}
                  onPress={() => setLoud(val)}
                >
                  <Text
            ...
            >
              {submitting ? (
                ...
                <Text style={styles.submitText}>Submit Ping</Text>
              )}
            </Pressable>
          </Card>
        )}
          ...
          <Card key={ping.id} style={styles.pingCard}>
            ...
            <View style={styles.pingStats}>
              <View
                style={[
                  styles.statBadge,
                  { backgroundColor: getCrowdColor(ping.crowded) + "22" },
                ]}
              >
                <Text
                  style={[
                    styles.statText,
                    { color: getCrowdColor(ping.crowded) },
                  ]}
                >
